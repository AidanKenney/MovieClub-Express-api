...
// boolean version of above, for checking each collection
const requireOwnershipBool = (requestObject, resource) => {
  const owner = resource.owner._id ? resource.owner._id : resource.owner

  return (requestObject.user._id.equals(owner))
}
